...
<main class="form-signin w-100 m-auto">
    <form action="" method="post">
        <img class="mb-4" src="./img/FERREGOD.png" alt="FERREGOD" width=120>
        <h4 class="text-secondary">FERREGOD</h4>
        <h1 class="h5 mb-3 fu-normal">Registro</h1>

        <div class="form-floating">
            <input type="text" class="form-control" id="floatingName"
                   placeholder="ingrese su nombre" required pattern="[A-Za-20-9]18, 12)">
            <label for="floatingName">Nombre</label>
        </div>
        <div class="form-floating">
            <input type="text" class="form-control" id="floatingLastName"
                   placeholder="ingrese su apellido" required pattern="[A-Za-20-9]18, 12)">
